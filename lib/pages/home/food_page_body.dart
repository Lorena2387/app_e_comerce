...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  double _heigth = Dimensions.pageViwContainer;
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              BigText(
                                  text: "Nutritious dish of Colombian peas"),
                              SizedBox(
                                height: Dimensions.height10,
                              ),
                              SmallText(text: "With Colombian characteristics"),
                              SizedBox(
                                height: Dimensions.height10,
                              ),
                              Row(
  ...
  Widget _buildPageItem(int index) {
    ...
    return Transform(
      ...
      child: Stack(
        children: [
          Container(
            height: Dimensions.pageViwContainer,
            margin: EdgeInsets.only(
          ...
          Align(
            ...
            child: Container(
              height: Dimensions.pageViwTextContainer,
              margin: EdgeInsets.only(
